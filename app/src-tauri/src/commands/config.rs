...
fn row_to_app_config(row: &rusqlite::Row) -> rusqlite::Result<AppConfig> {
    Ok(AppConfig {
        ...
        phone_t1_min: row.get("phone_t1_min")?,
        phone_t2_min: row.get("phone_t2_min")?,
        phone_t3_min: row.get("phone_t3_min")?,
        ...
        correlation_window_days: row.get("correlation_window_days")?,
        dropdown_options: row.get("dropdown_options")?,
